...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://bigboldfierce.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='big-bold-fierce']/div[1]/header/div[1]/p[1]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112056']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("This is  nice dress!!");
