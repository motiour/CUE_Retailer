...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://dressmavens.com/#");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/header/div[2]/div/nav/ul/li[7]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112055']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
