...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.craftedcupcompany.com/");
...
/*
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='TopMenu']/ul/li[5]/a"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116448']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("Oww This is nice mug!! I love it for my house");
