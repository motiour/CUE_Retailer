...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.magaschoni.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='TopMenu']/ul/li[4]"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114464']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
