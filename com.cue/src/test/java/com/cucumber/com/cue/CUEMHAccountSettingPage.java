...
public void mouseOver(WebElement element) {
	...
	public void MH_AccountSetting_Page() {
		...
		WebElement designImpTab = driver.findElement(By.xpath(".//*[@id='imi-app']/body/div[2]/div[1]/ul/li[3]/ul/li[2]/a"));
		designImpTab.click();
		delayFor(2000);

		

		WebElement dataImpTab = driver.findElement(By.xpath(".//*[@id='imi-app']/body/div[2]/div[1]/ul/li[3]/ul/li[3]/a"));
		dataImpTab.click();
		delayFor(2000);

		WebElement AssortmentTab = driver.findElement(By.xpath(".//*[@id='imi-app']/body/div[2]/div[1]/ul/li[3]/ul/li[4]/a"));
		AssortmentTab.click();
		delayFor(2000);
