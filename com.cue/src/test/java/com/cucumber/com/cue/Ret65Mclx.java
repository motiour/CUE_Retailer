...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.65mcmlxv.com/");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[3]/li/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath(".//*[@id='item-112064']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
