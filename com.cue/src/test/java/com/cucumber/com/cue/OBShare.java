...
public WebDriver driver = null;
	...
	public void shareByOB() {
		...
		driver.switchTo().frame(driver.findElement(By.id("oneButtonIFrame")));
 		...
 		WebElement OBEmail = driver.findElement(By.xpath("//*[@id='username']"));
 		OBEmail.clear();
 		OBEmail.sendKeys("nick45555@yahoo.com");
  		delayFor(2000);
  		
  		WebElement OBPassword = driver.findElement(By.xpath("//*[@id='pwd']"));
  		OBPassword.sendKeys("123456");
  		delayFor(2000);
  		
  		WebElement OBLoginButton = driver.findElement(By.xpath("//*[@id='login-button']"));
  		OBLoginButton.click();
 		delayFor(2000);
 		
 		WebElement FBShareIcon = driver.findElement(By.xpath("//*[@id='post-facebook']"));
