...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://firecracker-press.myshopify.com/");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[1]/div/ul/li[3]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-115744']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
