...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.maxwod.com/");
...
/*
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='headerRight']/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114269']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("I want this for enrich my Gymhouse");
