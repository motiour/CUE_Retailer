...
/*
        ...
        driver.get("http://www.artstar.com/");
         ...
         */
            ...
            driver.manage().window().maximize();
            driver.navigate().to("http://www.artstar.com/");
            driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
    ...
    @Test
	public void at60inches () {
    	
         
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/div/div/div[3]/ul/li[2]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-115351']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        delayFor(10000);
        ...
        CommentsBox.sendKeys("Hey Nina , I like this dress for Samantha");
