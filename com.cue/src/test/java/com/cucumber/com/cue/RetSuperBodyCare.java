...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://shop.superbodycare.com/");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='header']/nav[1]/ul/li[4]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112063']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("This is  Great item!!");
