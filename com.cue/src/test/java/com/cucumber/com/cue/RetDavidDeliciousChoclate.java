...
public class RetDavidDeliciousChoclate {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.davidsdeliciouschocolates.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='cue-stream-btn']/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114485']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
