...
public class RetRedcloudsCollective {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://redcloudscollective.com/products/the-waxed-canvas-duffle-bag");
...
/*
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[3]/div[5]/div/div[3]/ul/li[8]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114931']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("Oww I like this Bag!!");
        delayFor(5000);
