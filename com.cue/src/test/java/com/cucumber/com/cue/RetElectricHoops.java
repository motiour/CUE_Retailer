...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.eclectichoops.com/#");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='content_wrapper']/div/div[3]/div/div[2]/ul[2]/li[5]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112054']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("This is  nice hoop!!");
