...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://modernmini-3.myshopify.com");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[1]/div/div/ul[1]/li[7]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-111852']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("This is  Great picture!!");
