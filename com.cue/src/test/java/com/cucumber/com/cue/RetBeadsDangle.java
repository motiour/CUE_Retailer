...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.beadsanddangles.com/collections/chunk-snap-charms/products/chunk-snap-antique-silver-chunk-moon-stars-20-mm");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/div/div[2]/ul/li[3]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112058']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("This is  nice ornament!!");
