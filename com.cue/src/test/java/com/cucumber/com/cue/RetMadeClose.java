...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("https://madeclose.com/producers/michelle-farmer/brittany-silk-blouse");
...
/*
    ...
    @Test
	public void madeClose() {
    	
         
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='layout-top-navigation']/div/div/article[1]/div/a"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
		...
		WebElement menu = driver.findElement(By.xpath("//*[@id='browserWelcome']/div[4]/div/span/span")); // the triger event element
 		...
 		CUEEmail.sendKeys("rashed65555@yahoo.com");
  		delayFor(2000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-111375']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("Wow i like this item");
