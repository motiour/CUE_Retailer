...
public class RetUdderlyHotMama {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.udderlyhotmama.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/div[2]/ul/li[3]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112050']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
