...
public class RetReclamationetchworks {
...
/*
        ...
        driver.get("http://www.reclamationetchworks.com/");
        ...
        */
            ...
            driver.manage().window().maximize();
            driver.navigate().to("http://www.reclamationetchworks.com/");
            driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='Header']/div/div/div/div[1]"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116450']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
