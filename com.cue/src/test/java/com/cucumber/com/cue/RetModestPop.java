...
public class RetModestPop {
	...
	public WebDriver driver = null;
	    ...
	    public void beforeTest() {
	        ...
	        driver.get("http://www.modestpop.com/collections/dresses/products/eve-dress-spring-print");
	   ...
	   */
	            ...
	            driver.manage().window().maximize();
	            driver.navigate().to("http://www.modestpop.com/collections/dresses/products/eve-dress-spring-print");
	            driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		...
		public void spXMakeup () {
	        ...
	        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[3]/div/ul/li[2]/div"));
	 		delayFor(2000);
	 		mouseClick(CUElInk);
	 		delayFor(5000);
	        ...
	        WebElement Item = driver.findElement(By.xpath("//*[@id='item-115728']/div[2]/a"));
	        delayFor(10000);
	        mouseClick(Item);
	        ...
	        CommentsBox.sendKeys("This is  nice dress , i like it f0r my wife!!");
