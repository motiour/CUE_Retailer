...
public class CUEMH_BeaconManager {
...
public void mouseOver(WebElement element) {
	...
	public void MH_AccountSetting_Page() {
		...
		WebElement actImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[8]/a"));
		actImpTab.click();
		delayFor(2000);

		

		WebElement designImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[8]/ul/li[1]/a"));
		designImpTab.click();
		delayFor(2000);

		

		WebElement dataImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[8]/ul/li[2]/a"));
		dataImpTab.click();
		delayFor(2000);
