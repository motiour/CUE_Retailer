...
public class RetJewelryAffairs {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.jewelryaffairs.com/#");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='jewelry-rings-earrings-bracelets-necklaces-gold-chains']/div[1]/header/div/div/div[3]/div/div[1]/ul/li[2]/a/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112348']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
