...
public class RetRestoredDesign {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://restored-by-design.myshopify.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='nav']/li[3]/a"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-115546']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
