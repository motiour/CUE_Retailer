...
public class RetAxlBrand {
	...
	public WebDriver driver = null;
	    ...
	    public void beforeTest() {
	        ...
	        driver.get("http://www.axlbrand.com/");
	...
	/*
		...
		public void spXMakeup () {
	        ...
	        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/div[1]/div[3]/div[2]/div[2]/ul/li[4]/a/div"));
	 		delayFor(2000);
	 		mouseClick(CUElInk);
	 		delayFor(5000);
	        ...
	        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112047']/div[2]/a"));
	        delayFor(10000);
	        mouseClick(Item);
