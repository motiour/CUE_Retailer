...
public class RetKnowUrIngredients {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.know-your-ingredients.com/");
         ...
         */
            ...
            driver.manage().window().maximize();
            driver.navigate().to("http://www.know-your-ingredients.com/");
            driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/header/div/div/div[1]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116452']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("I love it");
