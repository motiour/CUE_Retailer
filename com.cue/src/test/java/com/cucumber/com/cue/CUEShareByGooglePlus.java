...
public class CUEShareByGooglePlus {
...
/*
	...
	public void shareByGooglePlus() {
         ...
         WebElement TwitterShareButton = driver.findElement(By.xpath("//*[@id='post-googleplus']"));
         ...
         CommentsBox.sendKeys("This is Google+ Great post!!");
