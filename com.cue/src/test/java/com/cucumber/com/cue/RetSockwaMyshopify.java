...
public class RetSockwaMyshopify {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://sockwa.myshopify.com/");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath(".//*[@id='nav-footer']/ul/li[17]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116526']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
