...
public class RetFirstVerseApparel {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://firstverseapparel.com/");
...
/*
	...
	public void spXMakeup () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='accounts']/li[4]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112060']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
