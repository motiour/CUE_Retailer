...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://www.giella.com");
...
/*
	...
	public void shareByTumblr() {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='TopMenu']/ul/li[4]/a"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114446']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("I love this item!!");
