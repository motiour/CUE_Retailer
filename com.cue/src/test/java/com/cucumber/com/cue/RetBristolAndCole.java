...
public class RetBristolAndCole {
		...
		public WebDriver driver = null;
		    ...
		    public void beforeTest() {
		        ...
		        driver.get("http://www.bristolandcole.com/");
		...
		/*
			...
			public void spXMakeup () {
		        ...
		        WebElement CUElInk = driver.findElement(By.xpath("html/body/header/section[1]/div[1]/div/div[1]/div"));
		 		delayFor(2000);
		 		mouseClick(CUElInk);
		 		delayFor(5000);
		        ...
		        WebElement Item = driver.findElement(By.xpath("//*[@id='item-112049']/div[2]/a"));
		        delayFor(10000);
		        mouseClick(Item);
