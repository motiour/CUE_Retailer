...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[2]/div[2]/div[3]/div/div[2]/ul[2]/li[6]/a"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116528']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        delayFor(10000);
