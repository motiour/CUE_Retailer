...
public class RetFiksReflective {
...
public WebDriver driver = null;
    ...
    public void beforeTest() {
        ...
        driver.get("http://fiks-reflective.myshopify.com/");
...
/*
	...
	public void at60inches () {
        ...
        WebElement CUElInk = driver.findElement(By.xpath("html/body/div[3]/div[4]/div/div[1]/ul/li[8]/div"));
 		delayFor(2000);
 		mouseClick(CUElInk);
 		delayFor(5000);
        ...
        WebElement Item = driver.findElement(By.xpath("//*[@id='item-116584']/div[2]/a"));
        delayFor(10000);
        mouseClick(Item);
        ...
        CommentsBox.sendKeys("Oww I like this Bicycle");
