...
public class RetInfinityHeadBand {
	...
	public WebDriver driver = null;
	    ...
	    public void beforeTest() {
	        ...
	        driver.get("http://www.infinityheadbands.com/");
	...
	/*
		...
		public void spXMakeup () {
	        ...
	        WebElement CUElInk = driver.findElement(By.xpath("//*[@id='infinity-headbands-by-ambrosia-designs']/div[1]/header/nav/div[2]/ul/li[7]/a/div"));
	 		delayFor(2000);
	 		mouseClick(CUElInk);
	 		delayFor(5000);
	        ...
	        WebElement Item = driver.findElement(By.xpath("//*[@id='item-114176']/div[2]/a"));
	        delayFor(10000);
	        mouseClick(Item);
	        ...
	        CommentsBox.sendKeys("This is  nice dress , i like it for my NIck baby!!");
