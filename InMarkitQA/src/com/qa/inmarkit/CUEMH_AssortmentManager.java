...
public class CUEMH_AssortmentManager {
...
public void mouseOver(WebElement element) {
	...
	public void MH_AccountSetting_Page() {
		...
		WebElement actImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[6]/a"));
		actImpTab.click();
		delayFor(2000);

		

		WebElement designImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[6]/ul/li[2]/a"));
															   //*[@id='imi-app']/body/div[2]/div[1]/ul/li[6]/ul/li[2]/a
		designImpTab.click();
		delayFor(2000);

		

		WebElement dataImpTab = driver.findElement(By.xpath("//*[@id='imi-app']/body/div[2]/div[1]/ul/li[6]/ul/li[3]/a"));
		dataImpTab.click();
		delayFor(2000);
